...
def load_config(config_path, default_config_path = None):
	"""Loads and read a yaml configuration file which
	   extends the default config for this project
	
		:param config_path: path of the configuration file to load
    	:type config_path: str
    	:param default_config_path: the path of the default configuration file. 
    		    If not set, the function will use the default_config.yaml file in the root directory.
